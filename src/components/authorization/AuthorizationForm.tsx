...
export interface SimulationData {
  ...
  // Add SimulationWithQuote compatibility
  ...
  const onSubmit = async (data: AuthorizationFormData) => {
    ...
    try {
      ...
      const authorizationRequest = {
        ...
        client_email: (quoteData.client_email as string) || '',
        client_phone: (quoteData.client_phone as string) || '',
        ...
        promoter_code: (quoteData.promoter_code as string) || null,
