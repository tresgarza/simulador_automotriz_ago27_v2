...
export interface ProfessionalAuthorizationData {
  ...
  authorization_data?: {
    ...
    mes1_fecha_ingresos?: string;
    mes2_fecha_ingresos?: string;
    mes3_fecha_ingresos?: string;
    mes1_fecha_gastos?: string;
    mes2_fecha_gastos?: string;
    mes3_fecha_gastos?: string;
...
export const generateProfessionalAuthorizationPDF = async (data: ProfessionalAuthorizationData): Promise<void> => {
  ...
  const incomes = [
    { mes: S.mes1_fecha_ingresos || "MES 1", nom: S.mes1_nomina, com: S.mes1_comisiones, neg: S.mes1_negocio, efe: S.mes1_efectivo },
    { mes: S.mes2_fecha_ingresos || "MES 2", nom: S.mes2_nomina, com: S.mes2_comisiones, neg: S.mes2_negocio, efe: S.mes2_efectivo },
    { mes: S.mes3_fecha_ingresos || "MES 3", nom: S.mes3_nomina, com: S.mes3_comisiones, neg: S.mes3_negocio, efe: S.mes3_efectivo },
  ];
  ...
  // ---- GASTOS (AutoTable)
  const expenses = [
    { mes: S.mes1_fecha_gastos || "MES 1", comp:S.mes1_compromisos, per:S.mes1_gastos_personales, neg:S.mes1_gastos_negocio },
    { mes: S.mes2_fecha_gastos || "MES 2", comp:S.mes2_compromisos, per:S.mes2_gastos_personales, neg:S.mes2_gastos_negocio },
    { mes: S.mes3_fecha_gastos || "MES 3", comp:S.mes3_compromisos, per:S.mes3_gastos_personales, neg:S.mes3_gastos_negocio },
  ];
