-- =========================================
-- BASE DE DATOS: SIMULADOR AUTOMOTRIZ (CORREGIDO)
-- Proyecto: sibiwavhwnxtrszjgqti (Catalogo Autos)
-- Prefijo de tablas: z_auto_
-- CORRECCIÓN: Ambiguous column references
-- =========================================
...
BEGIN
    ...
    RAISE NOTICE 'CORRECCIÓN: Columnas ambiguas resueltas';
    RAISE NOTICE '=====================================';
    RAISE NOTICE 'Proyecto: sibiwavhwnxtrszjgqti (Catalogo Autos)';
